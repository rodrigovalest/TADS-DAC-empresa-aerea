...
export const useFlightManagement = () => {
  ...
  useEffect(() => {
    const mockFlights: Flight[] = [
      { id: "1", date: "24/05/2025", time: "08:00", origin: "Aeroporto de Curitiba", destination: "Aeroporto de São Paulo/Guarulhos ", status: "CONFIRMADO" },
      { id: "2", date: "24/05/2025", time: "10:00", origin: "Aeroporto do Rio de Janeiro/Galeão", destination: "Aeroporto de Curitiba", status: "CONFIRMADO" },
      { id: "3", date: "24/05/2025", time: "14:00", origin: "Aeroporto Salgado Filho", destination: "Aeroporto do Rio de Janeiro/Galeão", status: "CONFIRMADO" },
      { id: "4", date: "24/05/2025", time: "18:00", origin: "Aeroporto de São Paulo/Guarulhos ", destination: "Aeroporto de Curitiba", status: "CONFIRMADO" },
      { id: "5", date: "25/05/2025", time: "08:00", origin: "Aeroporto de Curitiba", destination: "Aeroporto de São Paulo/Guarulhos ", status: "CONFIRMADO" },
      { id: "6", date: "25/05/2025", time: "10:00", origin: "Aeroporto do Rio de Janeiro/Galeão", destination: "Aeroporto de Curitiba", status: "CONFIRMADO" },
      { id: "7", date: "10/05/2025", time: "14:00", origin: "Aeroporto Salgado Filho", destination: "Aeroporto do Rio de Janeiro/Galeão", status: "CONFIRMADO" },
      { id: "8", date: "09/05/2025", time: "18:00", origin: "Aeroporto de São Paulo/Guarulhos ", destination: "Aeroporto de Curitiba", status: "CONFIRMADO" },
      { id: "9", date: "08/05/2025", time: "08:00", origin: "Aeroporto de Curitiba", destination: "Aeroporto de São Paulo/Guarulhos ", status: "CONFIRMADO" },
      { id: "10", date: "07/05/2025", time: "10:00", origin: "Aeroporto do Rio de Janeiro/Galeão", destination: "Aeroporto de Curitiba", status: "CONFIRMADO" },
      { id: "11", date: "06/05/2025", time: "14:00", origin: "Aeroporto Salgado Filho", destination: "Aeroporto do Rio de Janeiro/Galeão", status: "CONFIRMADO" },
      { id: "12", date: "05/05/2025", time: "18:00", origin: "Aeroporto de São Paulo/Guarulhos ", destination: "Aeroporto de Curitiba", status: "CONFIRMADO" },
